...
[⬇ Download `wikipedia_nobel_biographies_summaries_clean.parquet` (226 KB)](../data/wikipedia_nobel_biographies_summaries_clean.parquet){.btn .btn-outline-primary role="button" download="wikipedia_nobel_biographies_summaries_clean.parquet"}

```{r}
#| label: inspect-clean-data
library(arrow)

clean_text_data <- read_parquet("../data/wikipedia_nobel_biographies_summaries_clean.parquet")
...
[⬇ Download `wikipedia_nobel_biographies_summaries_clean_extended.parquet` (229 KB)](../data/wikipedia_nobel_biographies_summaries_clean_extended.parquet){.btn .btn-outline-primary role="button" download="wikipedia_nobel_biographies_summaries_clean_extended.parquet"}

- Read the `wikipedia_nobel_biographies_summaries_clean_extended.parquet`
...
wiki_summaries_ex <- read_parquet("../data/wikipedia_nobel_biographies_summaries_clean_extended.parquet")
